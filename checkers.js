...
function checkForWin() {
    if (blackScore === 0) {
        ...
        for (let i = 0; i < blackTurntext.length; i++) {
            ...
            whoWon.textContent = "BLACK WINS!!!";
        }
    }
    changePlayer();
}

theRedPiece = document.querySelector("#red-piece")
theBlackPiece = document.querySelector("#black-piece")

function changePlayer() {
    if (turn) {
        turn = false;
        for (let i = 0; i < redTurnText.length; i++) {
            theRedPiece.style.backgroundColor = "#FFD700"
            theRedPiece.style.border = "1px solid #FFD700"
            theBlackPiece.style.backgroundColor = "black"
            theBlackPiece.style.border = "1px solid white"
            redTurnText[i].style.color = "#FFD700";
            blackTurntext[i].style.color = "black";
        }
    } else {
        turn = true;
        for (let i = 0; i < blackTurntext.length; i++) {
            theBlackPiece.style.backgroundColor = "#FFD700"
            theBlackPiece.style.border = "1px solid #FFD700"
            theRedPiece.style.backgroundColor = "red"
            theRedPiece.style.border = "1px solid white"
            blackTurntext[i].style.color = "#FFD700";
            redTurnText[i].style.color = "black";
        }
    }
